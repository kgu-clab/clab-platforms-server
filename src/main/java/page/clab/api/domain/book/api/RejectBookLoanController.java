...
import page.clab.api.domain.book.application.RejectBookLoanService;
...
public class RejectBookLoanController {

    private final RejectBookLoanService rejectBookLoanService;
    ...
    public ApiResponse<Long> rejectBookLoan(
        ...
        Long id = rejectBookLoanService.execute(bookLoanRecordId);
