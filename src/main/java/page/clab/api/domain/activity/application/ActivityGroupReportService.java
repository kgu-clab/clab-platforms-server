...
import page.clab.api.domain.activity.dao.ActivityGroupReportRepository;
import page.clab.api.domain.activity.domain.ActivityGroup;
import page.clab.api.domain.activity.domain.ActivityGroupReport;
import page.clab.api.domain.activity.domain.ActivityGroupRole;
import page.clab.api.domain.activity.dto.request.ActivityGroupReportRequestDto;
import page.clab.api.domain.activity.dto.request.ActivityGroupReportUpdateRequestDto;
import page.clab.api.domain.activity.dto.response.ActivityGroupReportResponseDto;
