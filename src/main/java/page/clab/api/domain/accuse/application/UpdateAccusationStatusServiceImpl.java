...
public class UpdateAccusationStatusServiceImpl implements UpdateAccusationStatusService {
    ...
    @Transactional
    @Override
    public Long execute(TargetType type, Long targetId, AccuseStatus status) {
