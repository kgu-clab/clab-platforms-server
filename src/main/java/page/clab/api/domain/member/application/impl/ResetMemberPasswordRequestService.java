...
import page.clab.api.domain.member.application.ResetMemberPasswordRequestUseCase;
...
public class ResetMemberPasswordRequestService implements ResetMemberPasswordRequestUseCase {
    ...
    private Member validateResetPasswordRequest(MemberResetPasswordRequestDto requestDto) {
        Member member = memberLookupUseCase.getMemberByIdOrThrow(requestDto.getId());
