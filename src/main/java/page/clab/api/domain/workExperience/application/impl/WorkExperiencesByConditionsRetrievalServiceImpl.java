...
public class WorkExperiencesByConditionsRetrievalServiceImpl implements WorkExperiencesByConditionsRetrievalService {

    private final WorkExperienceRepository workExperienceRepository;

    @Override
    @Transactional(readOnly = true)
    public PagedResponseDto<WorkExperienceResponseDto> retrieveByConditions(String memberId, Pageable pageable) {
