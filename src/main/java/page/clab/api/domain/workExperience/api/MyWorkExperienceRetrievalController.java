...
public class MyWorkExperienceRetrievalController {
    ...
    private final MyWorkExperienceRetrievalUseCase myWorkExperienceRetrievalUseCase;
    ...
    public ApiResponse<PagedResponseDto<WorkExperienceResponseDto>> retrieveMyWorkExperience(
        ...
        PagedResponseDto<WorkExperienceResponseDto> myWorkExperience = myWorkExperienceRetrievalUseCase.retrieve(pageable);
