...
import page.clab.api.domain.jobPosting.application.port.in.JobPostingsByConditionsRetrievalUseCase;
...
public class JobPostingsByConditionsRetrievalService implements JobPostingsByConditionsRetrievalUseCase {
