...
public class DeletedReviewsRetrievalController {
    ...
    private final DeletedReviewsRetrievalUseCase deletedReviewsRetrievalUseCase;
    ...
    public ApiResponse<PagedResponseDto<ReviewResponseDto>> retrieveDeletedReviews(
        ...
        PagedResponseDto<ReviewResponseDto> reviews = deletedReviewsRetrievalUseCase.retrieve(pageable);
