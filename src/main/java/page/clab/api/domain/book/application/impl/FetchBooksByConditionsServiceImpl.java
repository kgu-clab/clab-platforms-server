...
public class FetchBooksByConditionsServiceImpl implements FetchBooksByConditionsService {
    ...
    @Override
    public PagedResponseDto<BookResponseDto> execute(String title, String category, String publisher, String borrowerId, String borrowerName, Pageable pageable) {
