...
public class RetrieveAccusationsController {

    private final RetrieveAccusationsService retrieveAccusationsService;
    ...
    public ApiResponse<PagedResponseDto<AccuseResponseDto>> retrieveAccusations(
        ...
        PagedResponseDto<AccuseResponseDto> accuses = retrieveAccusationsService.retrieveAccusations(type, status, countOrder, pageable);
