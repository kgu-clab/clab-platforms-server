...
public class ActivitySchedulesRetrievalController {
    ...
    private final ActivitySchedulesRetrievalUseCase activitySchedulesRetrievalUseCase;
    ...
    public ApiResponse<PagedResponseDto<ScheduleResponseDto>> retrieveActivitySchedules(
        ...
        PagedResponseDto<ScheduleResponseDto> schedules = activitySchedulesRetrievalUseCase.retrieve(startDate, endDate, pageable);
