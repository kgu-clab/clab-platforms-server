...
import page.clab.api.domain.activityPhoto.application.CreateActivityPhotoService;
...
public class CreateActivityPhotoController {

    private final CreateActivityPhotoService createActivityPhotoService;
    ...
    public ApiResponse<Long> createActivityPhoto(
        ...
        Long id = createActivityPhotoService.execute(requestDto);
