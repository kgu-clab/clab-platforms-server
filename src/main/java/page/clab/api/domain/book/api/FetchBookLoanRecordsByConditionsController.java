...
import page.clab.api.domain.book.application.FetchBookLoanRecordsByConditionsService;
...
public class FetchBookLoanRecordsByConditionsController {

    private final FetchBookLoanRecordsByConditionsService fetchBookLoanRecordsByConditionsService;
    ...
    public ApiResponse<PagedResponseDto<BookLoanRecordResponseDto>> getBookLoanRecordsByConditions(
        ...
        PagedResponseDto<BookLoanRecordResponseDto> bookLoanRecords = fetchBookLoanRecordsByConditionsService.execute(bookId, borrowerId, status, pageable);
