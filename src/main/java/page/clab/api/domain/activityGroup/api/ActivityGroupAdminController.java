...
public class ActivityGroupAdminController {
    ...
    @PostMapping("")
    public ResponseModel<Long> createActivityGroup(
    ...
    public ResponseModel<Long> updateActivityGroup(
    ...
    public ResponseModel<Long> manageActivityGroupStatus(
            @PathVariable(name = "activityGroupId") Long activityGroupId,
    ...
    public ResponseModel<Long> deleteActivityGroup(
            @PathVariable(name = "activityGroupId") Long activityGroupId
    ) {
    ...
    public ResponseModel<Long> updateProjectProgress(
            @PathVariable(name = "activityGroupId") Long activityGroupId,
    ...
    public ResponseModel<Long> addSchedule(
    ...
    @Secured({"ROLE_USER", "ROLE_ADMIN", "ROLE_SUPER"})
    @GetMapping("/members")
    public ResponseModel<PagedResponseDto<ActivityGroupMemberWithApplyReasonResponseDto>> getApplyGroupMemberList(
            @RequestParam(name = "activityGroupId") Long activityGroupId,
        ...
        return ResponseModel.success(groupMembers);
    }

    @Operation(summary = "[U] 신청 멤버 상태 변경", description = "ROLE_USER 이상의 권한이 필요함")
    @Secured({"ROLE_USER", "ROLE_ADMIN", "ROLE_SUPER"})
    @PatchMapping("/accept")
    public ResponseModel<String> acceptGroupMember(
            @RequestParam(name = "activityGroupId") Long activityGroupId,
