...
import page.clab.api.domain.activity.dao.AbsentRepository;
import page.clab.api.domain.activity.dao.AttendanceRepository;
import page.clab.api.domain.activity.dao.RedisQRKeyRepository;
...
import page.clab.api.domain.activity.dto.request.AbsentRequestDto;
import page.clab.api.domain.activity.dto.request.AttendanceRequestDto;
import page.clab.api.domain.activity.dto.response.AbsentResponseDto;
import page.clab.api.domain.activity.dto.response.AttendanceResponseDto;
import page.clab.api.domain.activity.exception.DuplicateAbsentExcuseException;
import page.clab.api.domain.activity.exception.DuplicateAttendanceException;
