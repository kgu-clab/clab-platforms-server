...
import page.clab.api.domain.login.application.port.in.LoginAttemptLogsRetrievalUseCase;
...
public class LoginAttemptLogsRetrievalService implements LoginAttemptLogsRetrievalUseCase {
