...
public class FetchMembersByConditionsController {

    private final FetchMembersByConditionsService fetchMembersByConditionsService;
    ...
    @GetMapping("")
    public ApiResponse<PagedResponseDto<MemberResponseDto>> fetchMembersByConditions(
        ...
        PagedResponseDto<MemberResponseDto> members = fetchMembersByConditionsService.fetchMembersByConditions(id, name, pageable);
