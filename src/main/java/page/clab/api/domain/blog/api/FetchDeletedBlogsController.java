...
import page.clab.api.domain.blog.application.FetchDeletedBlogsService;
...
public class FetchDeletedBlogsController {

    private final FetchDeletedBlogsService fetchDeletedBlogsService;
    ...
    public ApiResponse<PagedResponseDto<BlogDetailsResponseDto>> getDeletedBlogs(
        ...
        PagedResponseDto<BlogDetailsResponseDto> blogs = fetchDeletedBlogsService.execute(pageable);
