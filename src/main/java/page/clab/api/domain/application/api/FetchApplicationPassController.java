...
import page.clab.api.domain.application.application.FetchApplicationPassService;
...
public class FetchApplicationPassController {

    private final FetchApplicationPassService fetchApplicationPassService;
    ...
    public ApiResponse<ApplicationPassResponseDto> getApplicationPass(
        ...
        ApplicationPassResponseDto pass = fetchApplicationPassService.execute(recruitmentId, studentId);
