...
public class BooksByConditionsRetrievalController {
    ...
    public ApiResponse<PagedResponseDto<BookResponseDto>> retrieveBooksByConditions(
        ...
        PagedResponseDto<BookResponseDto> books = booksByConditionsRetrievalService.retrieveByConditions(title, category, publisher, borrowerId, borrowerName, pageable);
