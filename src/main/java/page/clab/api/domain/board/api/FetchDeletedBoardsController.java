...
public class FetchDeletedBoardsController {

    private final FetchDeletedBoardsService fetchDeletedBoardsService;
    ...
    public ApiResponse<PagedResponseDto<BoardListResponseDto>> getDeletedBoards(
        ...
        PagedResponseDto<BoardListResponseDto> boards = fetchDeletedBoardsService.fetchDeletedBoards(pageable);
