...
public class JobPostingsByConditionsRetrievalController {
    ...
    public ApiResponse<PagedResponseDto<JobPostingResponseDto>> retrieveJobPostingsByConditions(
        ...
        PagedResponseDto<JobPostingResponseDto> jobPostings = retrieveJobPostingsByConditionsUseCase.retrieve(title, companyName, careerLevel, employmentType, pageable);
