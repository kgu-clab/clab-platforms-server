...
public class DeletedCommentsRetrievalController {
    ...
    private final DeletedCommentsRetrievalUseCase deletedCommentsRetrievalUseCase;
    ...
    public ApiResponse<PagedResponseDto<DeletedCommentResponseDto>> retrieveDeletedComments(
        ...
        PagedResponseDto<DeletedCommentResponseDto> comments = deletedCommentsRetrievalUseCase.retrieve(boardId, pageable);
