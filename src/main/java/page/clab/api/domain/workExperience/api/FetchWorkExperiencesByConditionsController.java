...
public class FetchWorkExperiencesByConditionsController {

    private final FetchWorkExperiencesByConditionsService fetchWorkExperiencesByConditionsService;
    ...
    public ApiResponse<PagedResponseDto<WorkExperienceResponseDto>> fetchWorkExperiencesByConditions(
        ...
        PagedResponseDto<WorkExperienceResponseDto> workExperiences = fetchWorkExperiencesByConditionsService.fetchWorkExperiencesByConditions(memberId, pageable);
