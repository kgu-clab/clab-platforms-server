...
import page.clab.api.domain.hiring.application.application.port.in.RetrieveDeletedApplicationsUseCase;
...
public class DeletedApplicationRetrievalController {
    ...
    public ApiResponse<PagedResponseDto<ApplicationResponseDto>> retrieveDeletedApplications(
        ...
        PagedResponseDto<ApplicationResponseDto> applications = retrieveDeletedApplicationsUseCase.retrieveDeletedApplications(pageable);
