...
public class EmailService {
    ...
    public void sendAccountCreationEmail(Member member, String password) {
        EmailTemplateProperties.Template template = emailTemplateProperties.getTemplate(
    ...
    private void sendEmail(EmailDto emailDto, Member member, String message) {
        try {
            ...
            emailAsyncService.sendEmailAsync(member.getEmail(), emailDto.getSubject(), emailContent, null,
                emailDto.getEmailTemplateType());
