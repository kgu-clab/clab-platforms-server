...
public class DeletedDonationsRetrievalServiceImpl implements DeletedDonationsRetrievalService {
    ...
    @Override
    public PagedResponseDto<DonationResponseDto> retrieveDeleted(Pageable pageable) {
