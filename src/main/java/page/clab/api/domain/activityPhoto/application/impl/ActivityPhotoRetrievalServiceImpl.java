...
import page.clab.api.domain.activityPhoto.application.ActivityPhotoRetrievalService;
...
public class ActivityPhotoRetrievalServiceImpl implements ActivityPhotoRetrievalService {

    private final ActivityPhotoRepository activityPhotoRepository;

    @Transactional(readOnly = true)
    @Override
    public PagedResponseDto<ActivityPhotoResponseDto> retrievePhotos(Boolean isPublic, Pageable pageable) {
