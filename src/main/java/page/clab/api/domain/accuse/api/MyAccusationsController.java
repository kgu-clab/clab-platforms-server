...
public class MyAccusationsController {
    ...
    private final MyAccusationsService myAccusationsService;
    ...
    public ApiResponse<PagedResponseDto<AccuseMyResponseDto>> retrieveMyAccusations(
        ...
        PagedResponseDto<AccuseMyResponseDto> accuses = myAccusationsService.retrieveMyAccusations(pageable);
