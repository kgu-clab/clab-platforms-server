...
public class FetchFilesInMemberDirectoryServiceImpl implements FetchFilesInMemberDirectoryService {
    ...
    public PagedResponseDto<FileInfo> execute(String memberId, Pageable pageable) {
