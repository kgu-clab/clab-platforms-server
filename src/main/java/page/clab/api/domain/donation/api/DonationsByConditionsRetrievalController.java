...
public class DonationsByConditionsRetrievalController {
    ...
    private final DonationsByConditionsRetrievalUseCase donationsByConditionsRetrievalUseCase;
    ...
    public ApiResponse<PagedResponseDto<DonationResponseDto>> retrieveDonationsByConditions(
        ...
        PagedResponseDto<DonationResponseDto> donations = donationsByConditionsRetrievalUseCase.retrieve(memberId, name, startDate, endDate, pageable);
