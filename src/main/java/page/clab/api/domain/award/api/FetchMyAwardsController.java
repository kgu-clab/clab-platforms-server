...
public class FetchMyAwardsController {

    private final FetchMyAwardsService fetchMyAwardsService;
    ...
    public ApiResponse<PagedResponseDto<AwardResponseDto>> getMyAwards(
        ...
        PagedResponseDto<AwardResponseDto> myAwards = fetchMyAwardsService.execute(pageable);
