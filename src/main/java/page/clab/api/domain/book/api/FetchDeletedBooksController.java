...
import page.clab.api.domain.book.application.FetchDeletedBooksService;
...
public class FetchDeletedBooksController {

    private final FetchDeletedBooksService fetchDeletedBooksService;
    ...
    public ApiResponse<PagedResponseDto<BookDetailsResponseDto>> getDeletedBooks(
        ...
        PagedResponseDto<BookDetailsResponseDto> books = fetchDeletedBooksService.execute(pageable);
