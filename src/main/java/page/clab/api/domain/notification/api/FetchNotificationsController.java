...
import page.clab.api.domain.notification.application.FetchNotificationsService;
...
public class FetchNotificationsController {
    ...
    private final FetchNotificationsService fetchNotificationsService;
    ...
    public ApiResponse<PagedResponseDto<NotificationResponseDto>> getNotifications(
        ...
        PagedResponseDto<NotificationResponseDto> notifications = fetchNotificationsService.execute(pageable);
