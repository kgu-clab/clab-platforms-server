...
import page.clab.api.domain.book.application.ExtendBookLoanService;
...
public class ExtendBookLoanController {

    private final ExtendBookLoanService extendBookLoanService;
    ...
    public ApiResponse<Long> extendBookLoan(
        ...
        Long id = extendBookLoanService.execute(requestDto);
