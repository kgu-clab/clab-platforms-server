...
import page.clab.api.domain.activity.exception.ActivityGroupNotFinishedException;
import page.clab.api.domain.activity.exception.ActivityGroupNotProgressingException;
...
import page.clab.api.domain.activity.exception.DuplicateReportException;
