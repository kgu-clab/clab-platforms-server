...
public class ListActivityPhotosController {

    private final ListActivityPhotosService listActivityPhotosService;
    ...
    @GetMapping("")
    public ApiResponse<PagedResponseDto<ActivityPhotoResponseDto>> listActivityPhotos(
        ...
        PagedResponseDto<ActivityPhotoResponseDto> activityPhotos = listActivityPhotosService.listPhotos(isPublic, pageable);
