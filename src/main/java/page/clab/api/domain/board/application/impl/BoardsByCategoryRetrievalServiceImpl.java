...
import page.clab.api.domain.board.application.BoardsByCategoryRetrievalService;
...
public class BoardsByCategoryRetrievalServiceImpl implements BoardsByCategoryRetrievalService {
    ...
    @Transactional
    @Override
    public PagedResponseDto<BoardCategoryResponseDto> retrieveByCategory(BoardCategory category, Pageable pageable) {
