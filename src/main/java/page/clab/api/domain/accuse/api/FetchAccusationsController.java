...
public class FetchAccusationsController {

    private final FetchAccusationsService fetchAccusationsService;
    ...
    @GetMapping("")
    public ApiResponse<PagedResponseDto<AccuseResponseDto>> fetchAccusations(
        ...
        PagedResponseDto<AccuseResponseDto> accuses = fetchAccusationsService.execute(type, status, countOrder, pageable);
