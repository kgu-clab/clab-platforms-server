...
import page.clab.api.domain.application.application.ApplicationApprovalToggleService;
...
public class ApplicationApprovalToggleController {
    ...
    private final ApplicationApprovalToggleService applicationApprovalToggleService;
    ...
    public ApiResponse<String> toggleApprovalStatus(
        ...
        String id = applicationApprovalToggleService.toggleStatus(recruitmentId, studentId);
