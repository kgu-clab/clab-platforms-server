...
import page.clab.api.domain.book.application.BookDetailsRetrievalService;
...
public class BookDetailsRetrievalServiceImpl implements BookDetailsRetrievalService {
