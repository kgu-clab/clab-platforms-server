...
public class BoardsByCategoryRetrievalController {
    ...
    private final BoardsByCategoryRetrievalUseCase boardsByCategoryRetrievalUseCase;
    ...
    public ApiResponse<PagedResponseDto<BoardCategoryResponseDto>> retrieveBoardsByCategory(
        ...
        PagedResponseDto<BoardCategoryResponseDto> boards = boardsByCategoryRetrievalUseCase.retrieve(category, pageable);
