...
import page.clab.api.domain.book.application.OverdueBookLoanRecordsRetrievalService;
...
public class OverdueBookLoanRecordsRetrievalController {
    ...
    private final OverdueBookLoanRecordsRetrievalService overdueBookLoanRecordsRetrievalService;
    ...
    public ApiResponse<PagedResponseDto<BookLoanRecordOverdueResponseDto>> retrieveOverdueBookLoanRecords(
        ...
        PagedResponseDto<BookLoanRecordOverdueResponseDto> overdueRecords = overdueBookLoanRecordsRetrievalService.retrieve(pageable);
