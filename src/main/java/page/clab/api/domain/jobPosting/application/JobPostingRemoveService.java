...
import page.clab.api.domain.jobPosting.application.port.in.JobPostingRemoveUseCase;
...
public class JobPostingRemoveService implements JobPostingRemoveUseCase {
