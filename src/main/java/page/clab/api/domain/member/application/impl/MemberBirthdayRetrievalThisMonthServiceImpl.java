...
public class MemberBirthdayRetrievalThisMonthServiceImpl implements MemberBirthdayRetrievalThisMonthService {

    private final MemberRepository memberRepository;

    @Transactional(readOnly = true)
    @Override
    public PagedResponseDto<MemberBirthdayResponseDto> retrieveBirthdays(int month, Pageable pageable) {
