...
import page.clab.api.domain.comment.application.DeletedCommentsRetrievalService;
...
public class DeletedCommentsRetrievalController {
    ...
    private final DeletedCommentsRetrievalService deletedCommentsRetrievalService;
    ...
    public ApiResponse<PagedResponseDto<DeletedCommentResponseDto>> retrieveDeletedComments(
        ...
        PagedResponseDto<DeletedCommentResponseDto> comments = deletedCommentsRetrievalService.retrieveDeleted(boardId, pageable);
