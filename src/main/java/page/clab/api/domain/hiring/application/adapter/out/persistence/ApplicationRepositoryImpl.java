...
public class ApplicationRepositoryImpl implements ApplicationRepositoryCustom {
    ...
    @Override
    public Page<ApplicationJpaEntity> findByConditions(Long recruitmentId, String studentId, Boolean isPass,
        Pageable pageable) {
        QApplicationJpaEntity application = QApplicationJpaEntity.applicationJpaEntity;
        BooleanBuilder builder = new BooleanBuilder();

        if (recruitmentId != null) {
            builder.and(application.recruitmentId.eq(recruitmentId));
        }
