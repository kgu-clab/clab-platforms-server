...
public class FetchMyWorkExperienceController {

    private final FetchMyWorkExperienceService fetchMyWorkExperienceService;
    ...
    @GetMapping("")
    public ApiResponse<PagedResponseDto<WorkExperienceResponseDto>> fetchMyWorkExperience(
        ...
        PagedResponseDto<WorkExperienceResponseDto> myWorkExperience = fetchMyWorkExperienceService.fetchMyWorkExperience(pageable);
