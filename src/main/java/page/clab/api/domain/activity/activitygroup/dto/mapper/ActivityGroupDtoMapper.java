...
public class ActivityGroupDtoMapper {
    ...
    public ActivityGroupBoard fromDto(ActivityGroupBoardRequestDto requestDto, Member member,
        ActivityGroup activityGroup, ActivityGroupBoard parentBoard, List<UploadedFile> uploadedFiles) {
    ...
    public ActivityGroupDetailResponseDto toDto(ActivityGroup activityGroup, List<ActivityGroupBoardResponseDto> boards,
        List<GroupMemberResponseDto> groupMemberResponseDtos, boolean isOwner) {
    ...
    public ActivityGroupStatusResponseDto toDto(ActivityGroup activityGroup, List<LeaderInfo> leader,
    ...
    public ActivityGroupBoardChildResponseDto toChildDto(ActivityGroupBoard board,
        MemberBasicInfoDto memberBasicInfoDto, List<ActivityGroupBoardChildResponseDto> childrenDtos) {
    ...
    public AssignmentSubmissionWithFeedbackResponseDto toAssignmentDto(ActivityGroupBoard board,
        MemberBasicInfoDto memberBasicInfo, List<FeedbackResponseDto> feedbackDtos) {
    ...
    public ActivityGroupDetails of(ActivityGroup activityGroup, List<GroupMember> groupMembers,
        List<ActivityGroupBoard> activityGroupBoards) {
