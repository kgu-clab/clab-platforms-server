...
public class MyWorkExperienceRetrievalController {
    ...
    private final MyWorkExperienceRetrievalService myWorkExperienceRetrievalService;
    ...
    public ApiResponse<PagedResponseDto<WorkExperienceResponseDto>> retrieveMyWorkExperience(
        ...
        PagedResponseDto<WorkExperienceResponseDto> myWorkExperience = myWorkExperienceRetrievalService.retrieve(pageable);
