...
import page.clab.api.domain.membershipFee.application.FetchDeletedMembershipFeesService;
...
public class FetchDeletedMembershipFeesController {

    private final FetchDeletedMembershipFeesService fetchDeletedMembershipFeesService;
    ...
    public ApiResponse<PagedResponseDto<MembershipFeeResponseDto>> getDeletedMembershipFees(
        ...
        PagedResponseDto<MembershipFeeResponseDto> membershipFees = fetchDeletedMembershipFeesService.execute(pageable);
