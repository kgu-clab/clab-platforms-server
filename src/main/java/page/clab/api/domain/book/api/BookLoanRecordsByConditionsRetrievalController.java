...
public class BookLoanRecordsByConditionsRetrievalController {
    ...
    private final BookLoanRecordsByConditionsRetrievalService bookLoanRecordsByConditionsRetrievalService;
    ...
    public ApiResponse<PagedResponseDto<BookLoanRecordResponseDto>> retrieveBookLoanRecordsByConditions(
        ...
        PagedResponseDto<BookLoanRecordResponseDto> bookLoanRecords = bookLoanRecordsByConditionsRetrievalService.retrieveByConditions(bookId, borrowerId, status, pageable);
