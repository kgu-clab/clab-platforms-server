package page.clab.api.domain.attendance.application;
...
import page.clab.api.domain.attendance.dao.AttendanceRepository;
import page.clab.api.domain.login.dao.RedisQRKeyRepository;
import page.clab.api.global.file.application.FileService;
