...
import page.clab.api.domain.book.application.ApproveBookLoanService;
...
public class ApproveBookLoanController {

    private final ApproveBookLoanService approveBookLoanService;
    ...
    public ApiResponse<Long> approveBookLoan(
        ...
        Long id = approveBookLoanService.execute(bookLoanRecordId);
