...
import page.clab.api.domain.award.application.MyAwardRetrievalUseCase;
...
public class MyAwardRetrievalController {
    ...
    private final MyAwardRetrievalUseCase myAwardRetrievalUseCase;
    ...
    public ApiResponse<PagedResponseDto<AwardResponseDto>> retrieveMyAwards(
        ...
        PagedResponseDto<AwardResponseDto> myAwards = myAwardRetrievalUseCase.retrieve(pageable);
