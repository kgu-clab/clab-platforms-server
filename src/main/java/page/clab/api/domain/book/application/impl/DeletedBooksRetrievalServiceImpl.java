...
import page.clab.api.domain.book.application.DeletedBooksRetrievalService;
...
public class DeletedBooksRetrievalServiceImpl implements DeletedBooksRetrievalService {
    ...
    @Override
    public PagedResponseDto<BookDetailsResponseDto> retrieveDeleted(Pageable pageable) {
