...
public class FetchAwardsController {

    private final FetchAwardsService fetchAwardsService;
    ...
    public ApiResponse<PagedResponseDto<AwardResponseDto>> getAwardsByConditions(
        ...
        PagedResponseDto<AwardResponseDto> awards = fetchAwardsService.execute(memberId, year, pageable);
