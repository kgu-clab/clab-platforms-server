...
import page.clab.api.domain.activityPhoto.application.FetchActivityPhotosService;
...
public class FetchActivityPhotosController {

    private final FetchActivityPhotosService fetchActivityPhotosService;
    ...
    public ApiResponse<PagedResponseDto<ActivityPhotoResponseDto>> getActivityPhotosByConditions(
        ...
        PagedResponseDto<ActivityPhotoResponseDto> activityPhotos = fetchActivityPhotosService.execute(isPublic, pageable);
