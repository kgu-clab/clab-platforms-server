...
import page.clab.api.domain.book.application.FetchOverdueBookLoanRecordsService;
...
public class FetchOverdueBookLoanRecordsController {

    private final FetchOverdueBookLoanRecordsService fetchOverdueBookLoanRecordsService;
    ...
    public ApiResponse<PagedResponseDto<BookLoanRecordOverdueResponseDto>> getOverdueBookLoanRecords(
        ...
        PagedResponseDto<BookLoanRecordOverdueResponseDto> overdueRecords = fetchOverdueBookLoanRecordsService.execute(pageable);
