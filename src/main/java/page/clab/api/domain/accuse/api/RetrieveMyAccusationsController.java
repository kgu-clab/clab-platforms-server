...
import page.clab.api.domain.accuse.application.RetrieveMyAccusationsService;
...
public class RetrieveMyAccusationsController {

    private final RetrieveMyAccusationsService retrieveMyAccusationsService;
    ...
    public ApiResponse<PagedResponseDto<AccuseMyResponseDto>> retrieveMyAccusations(
        ...
        PagedResponseDto<AccuseMyResponseDto> accuses = retrieveMyAccusationsService.retrieveMyAccusations(pageable);
