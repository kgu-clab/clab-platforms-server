...
public class FetchCloudUsageByMemberIdServiceImpl implements FetchCloudUsageByMemberIdService {
    ...
    public CloudUsageInfo execute(String memberId) throws PermissionDeniedException {
