...
public class MyDonationsRetrievalController {
    ...
    private final MyDonationsRetrievalService myDonationsRetrievalService;
    ...
    public ApiResponse<PagedResponseDto<DonationResponseDto>> retrieveMyDonations(
        ...
        PagedResponseDto<DonationResponseDto> donations = myDonationsRetrievalService.retrieve(pageable);
