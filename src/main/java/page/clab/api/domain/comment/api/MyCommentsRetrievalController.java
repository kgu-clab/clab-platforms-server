...
public class MyCommentsRetrievalController {
    ...
    private final MyCommentsRetrievalService myCommentsRetrievalService;
    ...
    public ApiResponse<PagedResponseDto<CommentMyResponseDto>> retrieveMyComments(
        ...
        PagedResponseDto<CommentMyResponseDto> comments = myCommentsRetrievalService.retrieve(pageable);
