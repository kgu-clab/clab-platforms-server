...
import page.clab.api.domain.member.application.RequestResetMemberPasswordService;
...
public class RequestResetMemberPasswordController {

    private final RequestResetMemberPasswordService requestResetMemberPasswordService;
    ...
    public ApiResponse<String> requestResetMemberPassword(
        ...
        String id = requestResetMemberPasswordService.requestResetMemberPassword(requestDto);
