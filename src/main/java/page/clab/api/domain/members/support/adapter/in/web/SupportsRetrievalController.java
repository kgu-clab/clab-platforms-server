...
public class SupportsRetrievalController {

    private final RetrieveSupportUseCase retrieveSupportUseCase;
    private final PageableUtils pageableUtils;

    @Operation(summary = "[U,A] 문의 게시글 목록 조회", description = "INQUIRY 조회는 ROLE_USER 이상의 권한이 필요함<br>" +
    ...
    public ApiResponse<PagedResponseDto<SupportListResponseDto>> retrieveSupports(
        ...
        PagedResponseDto<SupportListResponseDto> supports = retrieveSupportUseCase.retrieveSupports(pageable);
        return ApiResponse.success(supports);
    }
}
