...
public class FetchBirthdaysThisMonthController {

    private final FetchBirthdaysThisMonthService fetchBirthdaysThisMonthService;
    ...
    @GetMapping("/birthday")
    public ApiResponse<PagedResponseDto<MemberBirthdayResponseDto>> fetchBirthdaysThisMonth(
        ...
        PagedResponseDto<MemberBirthdayResponseDto> birthdayMembers = fetchBirthdaysThisMonthService.fetchBirthdaysThisMonth(month, pageable);
