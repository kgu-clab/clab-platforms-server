...
import page.clab.api.domain.book.application.FetchBookDetailsService;
...
public class FetchBookDetailsController {

    private final FetchBookDetailsService fetchBookDetailsService;
    ...
    public ApiResponse<BookDetailsResponseDto> getBook(
        ...
        BookDetailsResponseDto book = fetchBookDetailsService.execute(bookId);
