...
import page.clab.api.domain.news.application.port.in.NewsDetailsRetrievalUseCase;
...
public class NewsDetailsRetrievalController {
    ...
    private final NewsDetailsRetrievalUseCase newsDetailsRetrievalUseCase;
    ...
    public ApiResponse<NewsDetailsResponseDto> retrieveNewsDetails(
        ...
        NewsDetailsResponseDto news = newsDetailsRetrievalUseCase.retrieve(newsId);
